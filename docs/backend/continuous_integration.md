...
## Setting up Sutta Contri with Drone.io Continuous Integration
...
5. Select ` sutta-contri-web ` for your repo
...
1. Click ( "Deployment" )[https://drone.io/github.com/aniketmaithani/sutta-contri-web/admin/deployments#/]
...
4. Add `https://git.heroku.com:sutta_contri-dev.git` under the Application Git URL
...
8. To have deployment for other branches including testing and production repeat steps 3 --> 7 with:
    - sutta_contri-qa for branch qa
    - sutta_contri-prod for branch prod
