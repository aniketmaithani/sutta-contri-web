# -*- coding: utf-8 -*-
"""Django settings for Sutta Contri project.
...
APPS_DIR = ROOT_DIR.path('sutta_contri')
...
ADMINS = getaddresses([env("DJANGO_ADMINS", default='maithani.aniket@gmail.com')])
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'sutta_contri.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    "EXCEPTION_HANDLER": "sutta_contri.base.exceptions.exception_handler",
}
# DJANGO_SITES
# ------------------------------------------------------------------------------
...
# URL CONFIGURATION
# ------------------------------------------------------------------------------
ROOT_URLCONF = 'sutta_contri.urls'
...
DATABASES = {
    'default': env.db("DATABASE_URL", default="postgres://localhost/sutta_contri"),
}
